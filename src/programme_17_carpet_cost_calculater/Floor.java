 ...
 * rectangular rooms. To calculate the price, you multiply the
 * area of the floor (width times length) by the
 * price per square meter of carpet. For example, the area of the floor
 * that is 12 meters long and 10
 ...
 */
public class Floor {
    // initializing two instance variable with double type
    double width;
    double length;
    // with two parameter constructor
    public Floor(double width, double length) {//condition declared
        // Check if width and length are less than 0 and set to 0 if necessary
        if (width < 0) {
            this.width = 0;
        } else {
            this.width = width;
    ...
    // getArea Instance method without parameter with return
